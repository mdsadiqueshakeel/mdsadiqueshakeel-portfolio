        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              >
                <span className="gradient-text">Md Sadique</span>
                <br />
              ...
              >
                <p>Fullstack Developer | Automation & System Design | AWS | UI/UX</p>
              </motion.div>
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              >
                <ImageWithFallback
                  src="https://via.placeholder.com/400x400/1a1a1a/ff6b35?text=MS"
